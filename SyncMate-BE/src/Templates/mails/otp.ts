export const otpEmailTemplate = (otp: string) => `
  <div style="background: #f6f8fa; border-radius: 16px; max-width: 420px; margin: 32px auto; box-shadow: 0 4px 24px rgba(44,62,80,0.10); font-family: Arial, sans-serif; color: #232f3e; padding: 32px 24px;">
    ...
    <h1 style="background: #ffffff; color: #232f3e; padding: 20px 0; border-radius: 8px; border:1.5px dashed #2b7a4b; box-shadow: 0 2px 6px rgba(44,62,80,0.08); text-align:center; font-size:34px; font-family:'Courier New',monospace; letter-spacing:6px; margin:0 0 24px 0;">
      ${otp}
    </h1>
    <div style="margin-bottom: 20px; text-align:center;">
      <span style="font-size:15px; color:#245236;">This code will expire in <strong>10 minutes</strong>.</span>
    </div>
